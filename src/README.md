...
- [1. Development Process](#1.-development-process)
    ...
    - [1.2. Software development plan](#1.2.-Software-development-plan)
    - [1.3. Diagram](#1.3.-Diagram)
        - [Workflow diagram](#Workflow-diagram)
        - [Data structure flow](#data-structure-flow)

- [2. About Application](#2.-about-application)
    - [2.1. Application purpose and scope](#2.1.-Application-purpose-and-scope)
        - [Description](#Description)
        - [Problem/Solution](#problem/solution)
        - [Target Audience](#Target-Audience)
    - [2.2. Features](#2.2.-Features)
    - [2.3. Code structure](#2.3.-Code-structure)
    - [2.4. Implementation plan](#2.4.-Implementation-plan)

- [3. User Experience](#3.-user-experience)
    - [3.1. Overview](#3.1.-Overview)
    - [3.2. User instructions](#3.2.-User-instructions)
...
![Data structure](/docs/data-structure-flow.png)

---
## 2. About Application
---

### 2.1 Application purpose and scope
...
---
## References
- [Diagrams editor](https://lucid.app)
- [Docker](https://www.docker.com/)
- [git](https://git-scm.com/)
- [gem artii](https://rubygems.org/gems/artii)
- [gem colorize](https://rubygems.org/gems/colorize)
- [gem date](https://rubygems.org/gems/date)
- [gem emojis](https://rubygems.org/gems/emojis)
- [gem rspec](https://rubygems.org/gems/rspec)
- [gem tty-prompt](https://rubygems.org/gems/tty-prompt)
